...
public partial class LoginPage : ContentPage
{
    ...
    private async void senhaClicked(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new SenhaPage());
    }
    ...
    private async void cadastarClicked(object sender, EventArgs e)
    {
